      ...
      <div className="flex flex-col items-center p-6 gap-6 bg-white text-black">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full max-w-md">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-100 transition duration-150 ease-in-out"
          >
            <img
